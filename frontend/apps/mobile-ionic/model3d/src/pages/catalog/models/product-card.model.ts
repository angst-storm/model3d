import {IFilterBaseResponseModel} from "../../../storage/server/product/models/response/filter-base.response-model";
import {IColorFilterResponseModel} from "../../../storage/server/product/models/response/color-filter.response-model";
